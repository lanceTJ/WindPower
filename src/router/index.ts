...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      },
      {
        path: "/adddata",
        name: "adddata",
        component: () => import("@/views/AddDataSets.vue"),
      },
      {
        path: "/washer",
        name: "washer",
        component: () => import("@/views/DataWasher.vue"),
      },
      {
        path: "/analyse",
        name: "analyse",
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "mydatasets",
            name: "account-mydatasets",
            component: () => import("@/views/crafted/account/MyDataSets.vue"),
          },
        ],
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import("@/views/crafted/modals/general/UpgradePlanBackup.vue"),
      },
      {
