    ...
    <div class="card-body p-0">
      ...
      <div class="card-p mt-n20 position-relative">
        ...
        <div class="row m-0">
          <a
            href="#/analyse"
            class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7 border border-4 border-grey-300 border-hover"
          >
            <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
              <inline-svg src="media/icons/duotune/general/gen032.svg" />
            </span>
            <div href="#" class="text-warning fw-semobold fs-6">
              {{ translator("Analyse") }}
            </div>
          </a>
          <a
            href="#/adddata"
            class="col bg-light-primary px-6 py-8 rounded-2 mb-7 border border-4 border-grey-300 border-hover"
          >
        ...
        <div class="row m-0">
          <a
            href="#/predict"
            class="col bg-light-danger px-6 py-8 rounded-2 me-7 border border-4 border-grey-300 border-hover"
          >
            <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-2">
              <inline-svg src="media/icons/duotune/abstract/abs039.svg" />
            </span>
            <a href="#" class="text-danger fw-semobold fs-6 mt-2">
              {{ translator("PowerPredict") }}
            </a>
          </a>
          <a
            href="#/washer"
            class="col bg-light-success px-6 py-8 rounded-2 border border-4 border-grey-300 border-hover"
          >
            <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
              <inline-svg src="media/icons/duotune/communication/com001.svg" />
            </span>
            <a href="#" class="text-success fw-semobold fs-6 mt-2">
              {{ translator("DataWasher") }}
            </a>
          </a>
        </div>
        <!--end::Row-->
