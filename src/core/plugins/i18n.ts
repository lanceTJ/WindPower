...
const messages = {
  en: {
    ...
    TheseAreYourDatasets: "These are your datasets",
    AddDatasetsButton: "Add New Dataset!",
    DownloadProcessedFile: "Download the cleaned file.",
    ChengduSichuan: "Chengdu Sichuan",
    noAccount: "No Account",
    LoginSuccess: "You have logined",
    PleaseInputPasswd: "Please input password",
    PleaseInputUsername: "Please input username",
    NetworkError: "Network error",
    UserOrPasswdWrong: "User or password wrong",
    AlreadyHadAccount: "Already had a account",
    ConfirmPassword: "Confirm password",
    UsernameNeed4Symbols: "Username need at least 4 Symbols",
    signUpSuccess: "Signup Successfully",
    UserExist: "User exist",
    failToRegister: "Fail to register",
    passwdAlert:
      "Please use at least 6 characters, including numbers, letters, special characters, etc",
  },
  zh: {
    passwdAlert: "请至少使用6位字符，包括数字，字母，特殊字符等",
    UserExist: "用户已存在",
    signUpSuccess: "注册成功",
    UserOrPasswdWrong: "用户名或密码错误",
    NetworkError: "网络异常",
    Retry: "重试",
    LoginSuccess: "登录成功",
    noAccount: "没有账号",
    ...
    Fixed: "无法更改",
    Password: "密码",
    UsernameNeed4Symbols: "用户名至少需要4个字符",
    PasswdAlert: "请至少使用6位字符，包括数字，字母，特殊字符等",
    ...
    AnalyseResult: "分析结果",
    ChooseParam: "选择展示参数",
    TheseAreYourDatasets: "以下这些是您的数据集",
    ChoosePredictParam: "选择预测参数",
