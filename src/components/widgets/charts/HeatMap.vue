<template>
  <div class="chart">
    ...
    <p v-if="description" class="text-gray text-center mb-2">
      {{ description }}
    </p>
    <div v-for="r in 7" :key="r" class="row">
      <div class="legend mr-1 text-gray text-xs text-mono">
        {{ weekdays[r - 1] }}
      </div>
      <div
        v-for="c in 24"
        ...
        :style="
          ...
          rgb +
          ', ' +
          dataset[r - 1][c - 1] / mailsPerWeekdayPerHourMax +
          ')'
        "
        :data-tooltip="
          weekdays[r - 1] +
    ...
    <div class="row">
      ...
      <div
        v-for="c in 24"
        :key="c"
        class="legend mt-1 text-gray text-sm text-center"
      >
